...
The 8-worker run is about 8.2x faster than the 1-worker run in this setup. The important point is not the exact number, it is that the downloader actually overlaps range requests and still produces identical bytes.
